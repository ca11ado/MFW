...
var Legenda = React.createClass({
    render: function(){
        return (
            <div id="wrapLegend">
                <ul>
                    <li>0 - лн, 1 - рц, 2 - дг, 3 - тз, 4 - чкх, 5 - пб, 6 - шщж, 7 - с, 8 - вф, 9 - м</li>
                    <li>Вбить число, которое нужно запомнить</li>
                    <li>Чтобы обновить список слов для пары чисел, удалить и вбить пару чисел заново.
                    Работает только для последней пары цифр набранного числа</li>
                    <li>Нажать на слово в списке, чтобы использовать его в предложении для запоминания</li>
                    <li>Максимум 9 пар чисел</li>
                </ul>
            </div>
        );
    }
